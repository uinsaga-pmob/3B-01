              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  onChanged: (String? newValue) {
                    ...
                    ); // Update state saat nilai berubah
                  },
                ),
              ),
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ), // Value dengan color sesuai konteks
        ],
      ),
    );
  }
          ...
          getTooltipItem: (group, groupIndex, rod, rodIndex) {
            return BarTooltipItem(
              ...
              children: [
                TextSpan(
                  text:
                      'Rp ${StatisticsRepository.formatTooltipCurrency(rod.toY)}', // Value formatted
                  style: TextStyle(
                    color: color,
                    fontWeight: FontWeight.w600,
                    fontSize: 12,
          ...
          barRods: [
            BarChartRodData(
              toY: entry.value.amount
                  .toDouble(), // Bar height berdasarkan amount
              color: color,
              width: _selectedPeriod == 'Tahun Ini'
                  ? 8
                  : 16, // Lebar bar berbeda berdasarkan periode
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: StatisticsRepository.categoryData
                        .map(_buildCategoryLegend)
                        .toList(),
                  ),
                ), // Legend
              ],
