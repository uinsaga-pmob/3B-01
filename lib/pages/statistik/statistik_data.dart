...
class SalesData {
  final String
  day; // Label hari/minggu/bulan (contoh: 'Sen', 'Minggu 1', 'Jan')
...
class StatisticsRepository {
  ...
  static final List<ProductData> topProducts = [
    ...
    ProductData(name: 'Americano', sales: 128, revenue: 1920000, growth: 8.3),
    ProductData(name: 'Latte', sales: 95, revenue: 1710000, growth: 15.2),
    ProductData(name: 'Matcha Late', sales: 87, revenue: 1590000, growth: 5.2),
  ];
